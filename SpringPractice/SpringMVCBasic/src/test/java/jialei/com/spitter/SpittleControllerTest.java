...
//        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(controller).build();
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/spittles/name"))
                .andExpect(MockMvcResultMatchers.view().name("spittles"))
                .andExpect(MockMvcResultMatchers.model().attributeExists("spittleList"))
                .andExpect(MockMvcResultMatchers.model().attribute("spittleList", hasItems(expectedSpittles.toArray())));


        mockMvc.perform(MockMvcRequestBuilders.get("/spittles/list"))
                .andExpect(MockMvcResultMatchers.view().name("spittles/list"))
                .andExpect(MockMvcResultMatchers.model().attributeExists("spittleList"))
                .andExpect(MockMvcResultMatchers.model().attribute("spittleList", hasItems(expectedSpittles.toArray())));
    }
    @Test
